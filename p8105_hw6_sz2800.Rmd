...
```
The mean of log(beta0 * beta1) is centered at 2.02 with a 95% confidence interval of (1.9649, 2.051).
...
The log(beta0 * beta1) is a symmtrical bell shaped curve that follows a normal distribution. This is most likely because of the large bootstrap sample of 500 samples. It is centered around 2.02 with 95% confidence interval of (1.9649, 2.051).
...
The mean is centered at 0.9152 with 95% confidence interval (0.8948, 0.9264).